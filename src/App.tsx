          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <motion.a 
                ...
                className="group relative p-8 rounded-[2rem] bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] hover:border-emerald-500/30 transition-all duration-500 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-4 sm:gap-6 min-w-0">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 shrink-0 rounded-2xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 border border-emerald-500/20 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
                      <WhatsappIcon className="w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-xs sm:text-sm text-slate-400 font-medium mb-1">WhatsApp</p>
                      <p className="text-lg sm:text-xl font-display font-semibold text-white group-hover:text-emerald-300 transition-colors truncate">956 606 972</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center md:justify-end">
              ...
              <a href="https://wa.me/51956606972" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-emerald-500/20 hover:text-emerald-400 hover:border-emerald-500/30 hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.2)]">
